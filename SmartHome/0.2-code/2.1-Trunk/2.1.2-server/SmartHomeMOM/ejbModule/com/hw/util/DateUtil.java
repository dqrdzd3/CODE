...
public class DateUtil {
	...
	public static boolean isLastManyDays(Date date1, Date date2, int pastDays) {
	...
	public static boolean isLastOneDay(Date date1, Date date2,int pastHours) {
		if (date1==null) return false;
	...
	/**
	 * * 得到几天前的时间 字符串* * @param d * @param day * @return
	 */
	public static String getStrDateBefore(Date d, int day) {
		SimpleDateFormat sf = new SimpleDateFormat("yyyyMMdd");
		
				return sf.format(getDateBefore(d, day));
	}
