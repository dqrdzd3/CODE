...
<s:form  method="post" id="d002Edit" >
<s:hidden id="ma001" name="d002PO.ma001" />
<div id="windows">
  <div id="windowstop">
    ...
    <div id="windowsbottomleft">
      <div id="windowsbottomright">
	      <ul>
	       ...
	       <li class="save"><input type="button" class="save" style="border:none;" id="saveBtn" onclick="modifyD002()" /></li>
