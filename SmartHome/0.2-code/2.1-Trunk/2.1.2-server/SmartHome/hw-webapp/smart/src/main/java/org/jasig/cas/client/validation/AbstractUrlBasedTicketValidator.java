...
public abstract class AbstractUrlBasedTicketValidator implements TicketValidator {
    ...
    protected final String constructValidationUrl(final String ticket, final String serviceUrl) {
        ...
        String slant = "%2F";
		int lastSlantIndex = result.lastIndexOf(slant);
        
//        return buffer.toString();
		System.out.println(result.substring(0, lastSlantIndex + slant.length()));
        return result.substring(0, lastSlantIndex + slant.length());
