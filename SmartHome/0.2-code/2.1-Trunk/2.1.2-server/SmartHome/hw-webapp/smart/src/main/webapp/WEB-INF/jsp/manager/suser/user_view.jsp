						...
						<tr>
							...
							<td class="tb_inputtwo">
								<s:textfield name="sysUserPO.LOGIN_NAME"  readonly="true"
									id="loginName"
									maxLength="20" /></td>
<!-- 									cssClass="{required:true,maxlength:20,remote:{type:'post',url:'manager/user!checkOnlyLoginName',data:{loginName:function(){return $('#loginName').val();}}},messages:{remote:'登录用户名已被使用'}}" -->
						...
						<tr>
							...
							<td class="tb_inputtwo">
								<s:select id="userType" cssStyle="display:none;" list="userType" listKey="value" listValue="display" disabled="true" name="sysUserPO.USER_TYPE" headerKey="" headerValue="请选择"  onchange="doChangeUserType(this)"/>
