...
function doUpdate(){
	...
	var url = "<%=basePath%>hwmobile/smart/corpcrm!doSaveEdit?ACCOUNT="+localStorage.getItem("PHONE","")+"&SESSIONID="+localStorage.getItem("PASSWORD","");
...
<div class="content-wrapper" style = "margin-left:0px;"> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
	   ...
	   <li class="active"><i class="fa fa-circle-o" style = "margin-right:5px;"></i>设备修改</li>
    </ol>
  </section>
                ...
                <form role="form" method="post" name = "form1" id = "form_crm" >
					...
					<div class="col-sm-8">
							<div class="col-sm-6">
							  <label>设备标识</label>
								...
								<div class="col-sm-6">
								<input type="text" style = "display:none" id = "corpCrmPO.ma001" name = "corpCrmPO.ma001" class="form-control" value = "${corpCrmPO.ma001}" >
							  <input  readonly="readonly" type="text" id = "corpCrmPO.ma002" name = "corpCrmPO.ma002" class="form-control" value = "${corpCrmPO.ma002}" placeholder="设备标识">
							  </div>
					</div>
					<div class="col-sm-2">
					</div>
					...
					<div class="col-sm-8">
							<div class="col-sm-6">
							  <label >收货人</label>
								...
								<div class="col-sm-6">
							  <input type="text" id = "corpCrmPOma004" name = "corpCrmPO.ma004" class="form-control" value = "${corpCrmPO.ma004}" placeholder="收货人">
							  </div>
					</div>
					<div class="col-sm-2">
					</div>
					...
					<div class="col-sm-8">
							<div class="col-sm-6">
							  <label>手机</label>
								...
								<div class="col-sm-6">
							  <input type="text" id = "corpCrmPOma005" name = "corpCrmPO.ma005" value = "${corpCrmPO.ma005}" class="form-control"  placeholder="手机">
							  </div>
					</div>
					<div class="col-sm-2">
					</div>
					...
					<div class="col-sm-8">
							<div class="col-sm-6">
							  <label>通讯地址</label>
								...
								<div class="col-sm-6">
							  <input type="text" class="form-control" id = "corpCrmPOma006" name = "corpCrmPO.ma006" value = "${corpCrmPO.ma006}" placeholder="通讯地址">
							  </div>
					</div>
					<div class="col-sm-2">
					</div>
					...
					<div class="col-sm-8">
							<div class="col-sm-6">
							  <label >备注</label>
								...
								<div class="col-sm-6">
							 <textarea class="form-control" id = "corpCrmPOma013" name = "corpCrmPO.ma013" value = "${corpCrmPO.ma013}" rows="3" placeholder="备注 ..."></textarea>
							  </div>
					</div>
					<div class="col-sm-2">
					</div>
				  ...
				  <div class="col-sm-8">
								...
								<div class="col-sm-6">
										...
										<div class="col-sm-3">
										<button onclick="doUpdate();" class="btn btn-primary">修改</button>
										</div>
										<div class="col-sm-3">
...
$(function (){
	...
	var locationID = "";
	locationID += "${corpCrmPO.ma015}";
	
	var pro = locationID.substr(0, 2);
	var city = locationID.substr(0, 4);
	var strict = locationID.substr(0,6);
	
	initComplexArea('seachprov', 'seachcity', 'seachdistrict', area_array, sub_array, '0', '0', '0');
	if(locationID.length == 6){
		
			//initComplexArea('seachprov', 'seachcity', 'seachdistrict', area_array, sub_array, pro, city, '0');
			
			changeComplexProvince(pro, sub_array, 'seachcity', 'seachdistrict');
			
			changeCity(city,'seachdistrict','seachdistrict');
			$("#seachprov").val(pro); 
			$("#seachcity").val(city);
			$("#seachdistrict").val(strict);
		}
	if(locationID.length == 4){
			//initComplexArea('seachprov', 'seachcity', 'seachdistrict', area_array, sub_array, pro, '0', '0');
