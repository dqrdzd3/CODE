		...
		<div id="windowsmain">
			...
			<div id="windowdiv">
				<div id="windowdivmain">
					<table cellspacing="0" cellpadding="0" class="windowdivmaintable" style="width:100%;">
						<tbody>
							...
							<tr>
								...
								<th><span> *</span> 有效期</th>
								<td class="tb_inputtwo"><s:textfield id="MA007" name="b005PO.MA007" 
										 cssClass='required Wdate' 
										 onfocus="hwDatePicker({minDate:$dp.$(MA006).value,dateFmt:'yyyy-MM-dd',readOnly:'true'})" />
							...
							<tr>
								...
								<td colspan="3"><s:textfield name="b005PO.MA006" id="MA006"
										cssClass='required Wdate' 
										onfocus="hwDatePicker({maxDate:$dp.$(MA007).value,dateFmt:'yyyy-MM-dd',readOnly:'true'})"
										style=" width:247px;"></s:textfield></td>
							</tr>
							<tr>
								<th>图片文件</th>
