					...
					<div>
						<table border="0" cellspacing="0" cellpadding="0" class="windowdivmaintable">
							...
							<tr>	
								...
								<td colspan="3" class="tb_inputtwo" scope="col">
									<!-- 放2个按钮 -->
						      		<iframe id="img" width="100%" height="150" src="<%=path%>/upload/fileupload!doAddupload?type=*.apk;&limit=1&MA002=<s:property value="m003PO.MA001" />" frameborder=0 border=0  marginwidth=0  marginheight=0  scrolling=0 ></iframe> 
