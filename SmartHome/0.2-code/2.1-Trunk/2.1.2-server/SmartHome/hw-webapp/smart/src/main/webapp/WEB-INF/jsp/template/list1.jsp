...
$(function(){
	$.hwPage({
		...
		listSize	:	[1,5,10,15],
		load		:	$.template.loadData1
	});
    $.hwBindBtn('add',$.template.add,'operating0');
});

</script>
<form action="" method="post" id="queryFrom1" style="display: none;">
		...
		<div class="framrighticon">
			<ul>
				...
				<li class="shuaxin" style="padding-right: 5px;"><a
					alt="刷新" href="javascript:$.template.loadData1()"></a></li>
				<!-- 隐藏表格 -->
					<li class="yincang"><a alt="隐藏"
						href="javascript:$.hwTb.hidden_table('divb1')"></a></li>
				</ul>
			</div>
		</div>
	</div>
...
<div class="tablethbj">
	<table border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			...
			<th onclick="$.hwTb.sortTable(this,'name','queryFrom1',$.template.loadData1)">姓名</th>
			<th onclick="$.hwTb.sortTable(this,'sex','queryFrom1',$.template.loadData1)">性别</th>
			<th onclick="$.hwTb.sortTable(this,'age','queryFrom1',$.template.loadData1)">年龄</th>
			<th onclick="$.hwTb.sortTable(this,'birth','queryFrom1',$.template.loadData1)">生日</th>
		</tr>
	</table>
</div>
