				...
				<div id="windowdivmain">
					<table border="0" cellspacing="0" cellpadding="0"
						...
						<tbody>
							...
							<tr>
								<th>性别</th>
								<td><s:radio list="sex"  listKey="value" listValue="name" name="b103PO.MA016" cssClass="radiostyle" value="1"></s:radio></td>
								<th>民族</th>
								...
								<th>出生日期</th>
								<td><s:textfield name="b103PO.MA018" cssClass=" Wdate"
...
<%-- 										cssClass='{required:true,maxlength:10}'></s:textfield></td> --%>
							...
							<tr>
								...
								<td><s:select list="codeValueAQRYLB"
										id="ma006" name="b103PO.MA006"  disabled="true"
										listKey="value" listValue="display"  ength="25" cssClass='required'></s:select>
									<input name="b103PO.MA024" type="hidden"/>
								</td>
...
<!-- 								<th>主要负责人资质证书</th> -->
<%-- 								<td colspan="5"><s:textfield name="b103PO.MA007" id="MA007"></s:textfield> --%>
<!-- 								</td> -->
<!-- 							</tr> -->
...
<script type="text/javascript">
	function roletochange1() {
		if (jQuery('#ab103 #ma006').val() == '3') {
			jQuery('#ab103 #tsgz').show();
			jQuery('#ab103 #tsgzbt').show();

		} else {
			jQuery('#ab103 #tsgz').val("");
			jQuery('#ab103 #tsgz').hide();
			jQuery('#ab103 #tsgzbt').hide();
		}
	}
</script>
