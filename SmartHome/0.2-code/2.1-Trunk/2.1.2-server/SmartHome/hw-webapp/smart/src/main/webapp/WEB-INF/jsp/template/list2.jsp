...
<script type="text/javascript">
	$(function(){
		$.hwPage({
			...
			listSize	:	[1,5,10,15],
			load		:	$.template.loadData2
		});
	    $.hwBindBtn('add',$.template.add,'operating1');
	});

</script>
<form action="" method="post" id="queryFrom2" style="display: none;">
		...
		<div class="framrighticon">
			<ul>
				...
				<li class="shuaxin" style="padding-right: 5px;"><a
					alt="刷新" href="javascript:$.template.loadData2()"></a></li>
				<!-- 隐藏表格 -->
					<li class="yincang"><a alt="隐藏"
						href="javascript:$.hwTb.hidden_table('divb2')"></a></li>
				</ul>
			</div>
		</div>
	</div>
...
<div class="tablethbj">
	<table border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			...
			<th onclick="$.hwTb.sortTable(this,'name','queryFrom2',$.template.loadData2)">姓名</th>
			<th onclick="$.hwTb.sortTable(this,'sex','queryFrom2',$.template.loadData2)">性别</th>
			<th onclick="$.hwTb.sortTable(this,'age','queryFrom2',$.template.loadData2)">年龄</th>
			<th onclick="$.hwTb.sortTable(this,'birth','queryFrom2',$.template.loadData2)">生日</th>
		</tr>
	</table>
</div>
