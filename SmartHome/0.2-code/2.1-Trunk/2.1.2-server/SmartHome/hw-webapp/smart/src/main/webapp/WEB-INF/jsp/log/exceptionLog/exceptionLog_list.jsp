...
function showContentById(id){
	if(id == null || id == ''){
		...
		$$.openDiv('logDiv','查看异常日志','log/exceptionLog!doView',{'logId':id},function(){});
	}
};
	...
	<div id="searcharea">
		<div id="searcharealeft">
			<div id="searcharearight">
				...
				<s:form action="log/exceptionLog" method="post" id="searchForm" cssClass="formmargin">
					...
					<table border="0" cellspacing="8" cellpadding="0">
						<tr>
							...
							<td colspan="4" style="width: 200px;">
								<s:textfield cssStyle="width: 200px;" name="exceptionLogPO.code" cssClass="input2"/>
							</td>
						</tr>
						<tr>
							<td align="right" style="width: 80px;">开始日期</td>
							<td colspan="1" style="width: 200px;">
								<s:textfield id="beginDate" name="exceptionLogPO.queryStartDate" cssClass="dateISO Wdate" dateformat="yyyy-MM-dd HH" width="50px"
							...
							<td colspan="1" style="width: 200px;">
								<s:textfield id="endDate" name="exceptionLogPO.queryEndDate" cssClass="dateISO Wdate" dateformat="yyyy-MM-dd" width="50px"
