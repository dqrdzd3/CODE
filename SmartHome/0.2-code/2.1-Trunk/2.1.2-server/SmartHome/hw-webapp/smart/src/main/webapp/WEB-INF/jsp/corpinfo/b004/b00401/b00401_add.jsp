						...
						<tbody>
							...
							<tr>
								...
								<td class="tb_inputtwo"><s:textfield name="b00401PO.MA005"
										id="MA005" cssClass='{maxlength:50}'></s:textfield></td>
							</tr>
							<tr>
								...
								<td class="tb_inputtwo"><s:textfield name="b00401PO.MA007"
										id="MA007" cssClass='{maxlength:50}'></s:textfield></td>
							</tr>
							<tr>
								...
								<td class="tb_inputtwo"><s:textfield name="b00401PO.MA009"
										id="MA009" cssClass='{maxlength:50}'></s:textfield></td>
							</tr>
							<tr>
								...
								<th scope="col"><span>*</span>有效截止日期</th>
							...
							<tr>
								<th scope="col"><span>*</span>数量</th>
								<td class="tb_inputtwo"><s:textfield name="b00401PO.MA021" cssClass="{required:true,digits:true,maxlength:10}"
										id="MA021"></s:textfield></td>
								<th scope="col"><span>*</span>是否是应急资源</th>
								<td class="tb_inputtwo"><s:radio name="b00401PO.MA015" cssClass="radiostyle required" list="#{'0':'是','1':'否'}" value="1"></s:radio></td>
							</tr>
							<tr>
								<th scope="col">监控管理负责人</th>
								<td class="tb_inputtwo"><s:textfield name="b00401PO.MA012"
										id="MA012" cssClass='{maxlength:20}'></s:textfield></td>
							...
							<tr>
								...
								<td colspan="3"><s:textarea name="b00401PO.MA013"
										id="MA013" cols="45" rows="5" maxlength="500"
							...
							<tr>
								...
								<td colspan="3"><s:textarea name="b00401PO.MA014"
										id="MA014" cols="45" rows="5" maxlength="500"
