...
<s:form action="department" method="post" name="deptform" id="editDeptform"> 
 ...
 <tr>
	    ...
	    <th><span class="red">*</span>部门编码 </th>
	      <td><s:textfield  name="deptPO.depart_code" id="deptKey" cssClass="{required:true,maxlength:20}" maxLength="20" disabled="true"></s:textfield></td>
	    </tr>
	    <tr>
	      <th>描&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;述</th>
	      <td>
      ...
      <ul>
	      <li>
	       ...
	       <li style="margin-right:8px;">
	       	<input class="submit" onclick="doSubmitEditData()"/>
	       </li>
