...
.noneb:hover {
 ...
 $(function(){
	 ...
	 $(".noneb").mousedown(function(){
		  $(this).css("background-color","#71D0E8");
		});
...
<header id = "headerTitle" class="main-header"> 
  ...
  <nav class="navbar navbar-static-top" role="navigation" id="navi"> 
    ...
    <button type="button" class="btn btn-info btn-lg noneb" style = "margin-top:2px" id = "material">耗材维护</button>
    <button type="button" class="btn btn-info btn-lg noneb" style = "margin-top:2px" id = "potential">潜在用户</button>
    <button type="button" class="btn btn-info btn-lg noneb" style = "margin-top:2px" id = "weiguoDiscuss">威果论坛</button>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user user-menu"> 
        		<a href="#" class="dropdown-toggle" data-toggle="dropdown"> 
        			<img width="16px" src="<%=basePath%>public/toB/dist/img/user_admin.jpg" class="user-image" alt="User Image"> 
