...
<s:form  method="post" id="k001Edit" >
<s:hidden id="ma001" name="k001PO.ma001" />
<div id="windows">
  <div id="windowstop">
    ...
    <div id="windowsbottomleft">
      <div id="windowsbottomright">
	      <ul>
	       ...
	       <li class="save"><input type="button" class="save" style="border:none;" id="saveBtn" onclick="modifyK001()" /></li>
