...
<script type="text/javascript" src='<s:url value="/js/manager/device/m001.js"></s:url>'></script>
</head>
...
<body>
			...
			<div id="searcharearight">
				<s:form action="" method="post" cssClass="formmargin" name="searchForm" id="searchForm"> 
					<table border="0" cellspacing="8" cellpadding="0">
				      <tr>
				        <td align="right" style="width:50px;"  nowrap="nowrap">设备名称</td>
				          <td style="width:250px;" nowrap="nowrap">
					          	<s:textfield name="m001PO.MA002" cssClass="input2"/>
					       </td>
	...
	<div style="display: none;" id="m001Div"></div>
