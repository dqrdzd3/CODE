...
<link href="<%=basePath%>public/css/base.css" rel="stylesheet"
	type="text/css">
<link href="<%=basePath%>public/css/login.css" rel="stylesheet"
	type="text/css">
	...
	<div class="login">
		<form id="form_login" styleId="form_login">
			...
			<div class="login_form">
				...
				<div class="user">
					<input class="text_value" value="" id="username" name="username"
						type="text" id="username" placeholder="用户名" /> <input
						class="text_value" value="" id="password" name="password"
