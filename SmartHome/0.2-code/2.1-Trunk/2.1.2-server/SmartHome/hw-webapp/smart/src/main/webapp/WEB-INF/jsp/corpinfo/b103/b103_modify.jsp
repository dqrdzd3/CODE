				...
				<div id="windowdivmain">
					<table border="0" cellspacing="0" cellpadding="0"
						...
						<tbody>
							...
							<tr>
								<th>性别</th>
								<td><s:radio list="sex" name="b103PO.MA016" listKey="value" listValue="name" cssClass="radiostyle"></s:radio></td>
								<th>民族</th>
								...
								<th>出生日期</th>
								<td><s:textfield name="b103PO.MA018"
										cssClass="Wdate"
										onclick="hwDatePicker({dateFmt:'yyyy-MM-dd',readOnly:'true'})"
										><s:param name="value"><s:date name="b103PO.MA018" format="yyyy-MM-dd"/></s:param></s:textfield></td>
							</tr>
							<tr>
								<th>学历</th>
								<td><s:select list="codeValueXL" name="b103PO.MA019" cssStyle="width:135px;"
								...
								<th><span> *</span> 职务</th>
								<td><s:textfield name="b103PO.MA005" id="MA005"
							...
							<tr>
								...
								<td><s:select list="codeValueAQRYLB"
										onchange="roletochange1()" id="ma006" name="b103PO.MA006"
							...
							<tr style="display: none;" id="_aptitude">
								<th>主要负责人资质证书</th>
								<td colspan="5"><s:textfield name="b103PO.MA007" cssClass='{maxlength:2}'></s:textfield>
								</td>
							</tr>
							<tr style="display: none;" id="_grade">
								<th>级别</th>
								<td colspan="5"><s:textfield name="b103PO.MA011" id="MA011"  cssClass='{maxlength:2}'></s:textfield>
								</td>
							</tr>
							<tr style="display: none;" id="_complexion">
								<th>注册情况</th>
								<td colspan="5"><s:textfield name="b103PO.MA008" id="MA008" cssClass='{maxlength:2}'></s:textfield>
								</td>
							</tr>
							<tr>
...
// 					.html(
// 							'<select name="b103PO.MA021"><option value="1">农民工</option></select>');
// 		} else {
// 			if (jQuery('#updform #othertype')) {
// 				jQuery('#updform #ptypedesc').text('');
// 				jQuery('#updform #ptypetd').html(
// 						'<input type="hidden" name="b103PO.MA021" value="0"/>');
// 			}
// 		}
// 	};
	$(function(){
