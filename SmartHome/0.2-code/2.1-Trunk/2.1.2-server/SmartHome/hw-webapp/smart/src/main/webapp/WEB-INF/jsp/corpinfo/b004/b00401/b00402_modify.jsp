				...
				<div id="windowdivmain">
					<table border="0" cellspacing="0" cellpadding="0"
						...
						<tbody>
							...
							<tr>
								<th scope="col"><span>* </span>检验机构123123</th>
								<td class="tb_inputtwo"><s:textfield name="b00402PO.ma003" cssClass='{required:true,maxlength:50}'></s:textfield></td>
								<th scope="col">检验时间</th>
								<td class="tb_inputtwo"><s:textfield name="b00402PO.ma005"  cssClass='{maxlength:50}'></s:textfield></td>
							</tr>
							<tr>
								<th scope="col"><span>*</span>是否通过检验</th>
								<td class="tb_inputtwo">
								<s:radio name="b00402PO.ma006" cssClass="required"list="codeValueSBLX" listKey="value" listValue="name"></s:radio>
								</td>
								<th scope="col">周期</th>
								<td class="tb_inputtwo">
