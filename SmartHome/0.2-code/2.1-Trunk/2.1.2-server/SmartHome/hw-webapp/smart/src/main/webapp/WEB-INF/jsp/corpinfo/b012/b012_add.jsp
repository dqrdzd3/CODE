...
<s:form action="b012" method="post" id="b012addform"> 
<div id="windows">
  <div id="windowstop">
  ...
  <tr>
    ...
    <th><span>*</span> 数量 </th>
    <td><s:textfield name="b012PO.MA007" id="MA007" cssClass='{required:true,number:true,maxlength:17,decimal:true,min:0}' ></s:textfield></td>
  ...
  <tr>
    <th style="width:120px;">危险物质名称说明<br><span>25字以内</span></th>
