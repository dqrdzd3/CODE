...
public class SessionManager implements ConfigDefs {
	 ...
	 * 
	 * @修改人 马宁
	 * @修改时间 2013-09-03 09:12
	 * @修改内容 Session创建时不再使用原来的随机sessionId,而是使用页面传过来的hw_s_id作为sessionId的参数
	 */
	public Session createSession(Event anEvent) throws PushletException {
		// Trivial
//		return Session.create(createSessionId());
		return Session.create(anEvent.getField(Event.HW_SESSOIN_ID, createSessionId()));
	}
