...
public class SensorConstant {
	/** 自留未定义设备类型 */
	public final static int SENSOR_TYPE_ERROR = 0;
	/** 可燃气体设备类型 */
	public final static int SENSOR_TYPE_GAS = 1;
	/** 空气质量设备类型 */
	public final static int SENSOR_TYPE_AIR = 2;
	/** 烟雾设备类型 */
	public final static int SENSOR_TYPE_SOMKE = 3;
	/** 被控设备类型 */
	public final static int SENSOR_TYPE_CTRL = 4;
