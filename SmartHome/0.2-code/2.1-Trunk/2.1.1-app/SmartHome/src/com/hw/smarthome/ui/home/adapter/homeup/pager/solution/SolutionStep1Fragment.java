 ...
 */
public class SolutionStep1Fragment extends Fragment {
	private static SolutionStep1Fragment instance;
	...
	public static SolutionStep1Fragment getInstance(
			String sensorId) {
		if (instance == null) {
			instance = new SolutionStep1Fragment();
		}
