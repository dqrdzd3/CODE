...
//	 * 设置背景模糊
//	 */
//	public static void blurBg(Activity context) {
//		context.getWindow()
//				.setFlags(
//						context.WindowManager.LayoutParams.FLAG_BLUR_BEHIND,
//						context.WindowManager.LayoutParams.FLAG_BLUR_BEHIND);
//	}
	...
	/**
	 * dip转px dip即device independent pixel，设备独立像素
	 * 
	 * @author 曾凡
	 * @param context
	 * @param dipValue
	...
	/**
	 * px转dip px即pixels，是绝对像素，有多少个像素点就是多少个像素点。
	 * 
	 * @author 曾凡
	 * @param context
	 * @param pxValue
	 ...
	 * @time 2014年7月10日 下午2:12:48
	 */
	public static int getDeviceStatusHeight(Activity context) {
		Rect frame = new Rect();
	 ...
	 * @time 2014年7月10日 下午2:12:48
	 */
	public static int getDeviceTitleHeight(Activity context) {
		int contentTop = context.getWindow()
				.findViewById(Window.ID_ANDROID_CONTENT)
				.getTop();
		// statusBarHeight是上面所求的状态栏的高度
		return contentTop - getDeviceStatusHeight(context);
	}
