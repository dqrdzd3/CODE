package com.hw.smarthome.view.search;
...
import com.hw.smarthome.view.list.PinnedHeaderListView.PinnedHeaderAdapter;

public class CityAdapter extends BaseAdapter implements
	...
	public View getView(int position, View convertView,
		...
		if (convertView == null) {
			convertView = inflater.inflate(
					R.layout.view_select_city_item, null);
		}
	...
	public int getSectionForPosition(int position) {
		...
		int index = Arrays.binarySearch(mPositions.toArray(),
				position);
