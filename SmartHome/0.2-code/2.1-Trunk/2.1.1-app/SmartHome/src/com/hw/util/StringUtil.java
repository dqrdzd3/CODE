...
//			}
	 ...
	 * @return
	 */
	public static List<String> getTagsList(String originalText,int c) {
     ...
     * 功能描述：(去掉html标签)
     * 输入参数：
     * @param inputString String 输入字符串
     * 返 回 值： 
     * @return String 去除html标签后字符串
     * 异    常： (按照异常名字的字母顺序)
     * 创建人：lijing
     * 创建时间：2013-11-25 上午11:10:50
     * 修改人：
     * 修改时间：
     * 修改原因描述：
     */
