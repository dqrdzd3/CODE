package com.hw.smarthome.view.progressbar;
...
public class ProgressBarAction {
	...
	public ProgressBarAction(Activity activity,
	...
	public void updateDatas(String jsMsg) {
		ProgressEntity entity = new Gson().fromJson(
				Strings.toString(jsMsg), ProgressEntity.class);
