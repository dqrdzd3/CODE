...
import com.hw.util.SystemMethod;

public class TitleBarTranView extends RelativeLayout {
	...
	public TitleBarTranView(Context context) {
		super(context);
		mContext = context;
		initView();
	}

	public TitleBarTranView(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		initView();
	}
	...
	private void initView() {
		LayoutInflater.from(mContext).inflate(
				R.layout.view_title_bar_tran, this);
	...
	public void setCommonTitle(int LeftVisibility,
			int centerVisibility, int center1Visibilter,
			int rightVisibility) {
	...
	@SuppressLint("NewApi")
	public void setPopWindow(PopupWindow mPopWindow,
			TitleBarTranView titleBaarView) {
		...
		setBtnRight(R.drawable.view_skin_title_right_btn_selected);
	}
