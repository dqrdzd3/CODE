...
public class CustomExpandableListView extends ExpandableListView
	...
	public CustomExpandableListView(Context pContext,
			AttributeSet pAttrs) {
	...
	private void addHeadView() {
		mHeadView = (LinearLayout) mInflater.inflate(
				R.layout.view_refresh_head, null);
	...
	private void addFooterView() {
		mEndRootView = mInflater.inflate(
				R.layout.view_refresh_footer, null);
	 ...
	 */
	@Override
	public void onScroll(AbsListView pView,
			int pFirstVisibleItem, int pVisibleItemCount,
			int pTotalItemCount) {
	 ...
	 */
	@Override
	public void onScrollStateChanged(AbsListView pView,
			int pScrollState) {
		if (mCanLoadMore) {// 存在加载更多功能
			if (mLastItemIndex == mCount
					&& pScrollState == SCROLL_STATE_IDLE) {
		...
		if (mCanRefresh) {
			...
			case MotionEvent.ACTION_MOVE:
				...
				if (mHeadState != REFRESHING && mIsRecored
					...
					if (mHeadState == PULL_TO_REFRESH) {
						mHeadView.setPadding(0, -1
								* mHeadViewHeight
								+ (tempY - mStartY) / RATIO, 0,
								0);
	...
	private void changeHeaderViewByState() {
		...
		case RELEASE_TO_REFRESH:
			...
			// 松开刷新
			mTipsTextView
					.setText(R.string.p2refresh_release_refresh);
		...
		case PULL_TO_REFRESH:
			...
			if (mIsBack) {
				...
				mArrowImageView.clearAnimation();
				mArrowImageView
						.startAnimation(mArrowReverseAnim);
				// 下拉刷新
				mTipsTextView
		...
		case REFRESHING:
			...
			// 正在刷新...
			mTipsTextView
					.setText(R.string.p2refresh_doing_head_refresh);
			mLastUpdatedTextView.setVisibility(View.VISIBLE);

			break;
		case DONE:
			mHeadView.setPadding(0, -1 * mHeadViewHeight + (-1),
					0, 0);
			...
			mArrowImageView.clearAnimation();
			mArrowImageView
					.setImageResource(R.drawable.view_refresh_arrow);
			// 下拉刷新
			mTipsTextView
					.setText(R.string.p2refresh_pull_to_refresh);
			mLastUpdatedTextView.setVisibility(View.VISIBLE);
	...
	public void setOnRefreshListener(
			OnRefreshListener pRefreshListener) {
