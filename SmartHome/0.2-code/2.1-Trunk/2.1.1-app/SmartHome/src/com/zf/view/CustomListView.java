...
public class CustomListView extends ListView implements OnScrollListener {
	...
	private void addHeadView() {
		mHeadView = (LinearLayout) mInflater.inflate(R.layout.view_refresh_head, null);
	...
	private void addFooterView() {
		mEndRootView = mInflater.inflate(R.layout.view_refresh_footer, null);
	...
	private void changeHeaderViewByState() {
		...
		case DONE:
			...
			mProgressBar.setVisibility(View.GONE);
			mArrowImageView.clearAnimation();
			mArrowImageView.setImageResource(R.drawable.view_refresh_arrow);
			// 下拉刷新
			mTipsTextView.setText(R.string.p2refresh_pull_to_refresh);
			mLastUpdatedTextView.setVisibility(View.VISIBLE);
