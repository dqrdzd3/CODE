        ...
        * than true / false */
        ...
        drawLoader = function () {
            ...
            (function () {
                ...
                percentageText.style.top = (((settings.height+20) / 2) - (fontSize / 2)).toString() + 'px';
                percentageText.style.color = '#80a9c8';
                percentageText.style.font = (fontSize-2).toString() + 'px BebasNeueRegular';
                percentageText.style.textShadow = '0 1px 1px #FFFFFF';
                /* 曾凡 20140610 
                 * curValue/maxValue = curPerValue
                 * string = maxValue*curPerValue */
                var maxValue = 1000.0;
                var unit = "毫克/立方";
                var title = "PM2.5 ";
                ...
                percentageTextUp.style.top = (((settings.height-20) / 2) - (fontSize / 2)).toString() + 'px';
                percentageTextUp.style.color = '#80a9c8';
                percentageTextUp.style.font = fontSize.toString() + 'px BebasNeueRegular';
                percentageTextUp.style.textShadow = '0 1px 1px #FFFFFF';
                percentageTextUp.innerHTML = title;

                /* Calculate font and placement of small 'value' text */
                smallSize = cX / 5.5;
                valueText.style.color = '#80a9c8';
                /* 曾凡 20140612 font-4 */
                valueText.style.font = (smallSize-4).toString() + 'px BebasNeueRegular';
