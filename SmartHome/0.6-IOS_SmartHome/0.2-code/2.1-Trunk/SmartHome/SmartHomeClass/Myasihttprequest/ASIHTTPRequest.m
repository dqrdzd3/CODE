...
- (id)initWithURL:(NSURL *)newURL
{
	...
	[self setPersistentConnectionTimeoutSeconds:30.0];
...
- (NSString *)responseString3
{
    ...
    //W#
    return [NSString stringWithCString:[data bytes] encoding: enc];
}
...
//#W
-(void)startCookieAsynchronous:(NSString *)strusername session:(NSString*)strsession{
    [self setUseCookiePersistence:NO];
    
    NSMutableDictionary *properties1 = [[NSMutableDictionary alloc] init];
    [properties1 setValue:strusername forKey:NSHTTPCookieValue];
    [properties1 setValue:@"mark" forKey:NSHTTPCookieName];
    ...
    NSMutableDictionary *properties2 = [[NSMutableDictionary alloc] init];
    [properties2 setValue:strsession forKey:NSHTTPCookieValue];
    [properties2 setValue:@"jsessionid" forKey:NSHTTPCookieName];
    [properties2 setValue:@"" forKey:NSHTTPCookieDomain];
    ...
    self.requestCookies = [NSMutableArray arrayWithObjects:cookie1,cookie2,nil];
...
+ (void)updateProgressIndicator:(id *)indicator withProgress:(unsigned long long)progress ofTotal:(unsigned long long)total
{
		...
		CGFloat progressAmount = (CGFloat)((progress*1.0)/(total*1.0));
