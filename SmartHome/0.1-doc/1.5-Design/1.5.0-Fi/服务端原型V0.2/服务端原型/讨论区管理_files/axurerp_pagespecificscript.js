...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('新增_1.html');

}
});
gv_vAlignTable['u120'] = 'center';document.getElementById('u131_img').tabIndex = 0;
