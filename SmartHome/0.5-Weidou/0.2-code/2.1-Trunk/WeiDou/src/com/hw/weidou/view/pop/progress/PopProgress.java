package com.hw.weidou.view.pop.progress;
...
public class PopProgress {
	...
	public static PopProgress getInstance(Context context, View parent) {
		if (singlePopProgress == null) {
			singlePopProgress = new PopProgress(context, parent);
		}
		return  singlePopProgress;
	}
	public static PopProgress getInstance(Context context, View parent, long time) {
		if (singlePopProgress == null) {
			singlePopProgress =new PopProgress(context, parent,time);
		}
		return singlePopProgress;
	}
	...
	public PopupWindow initPopWindow() {
		...
		mPopResultImage = (ImageView) popView.findViewById(R.id.popResultImage);
