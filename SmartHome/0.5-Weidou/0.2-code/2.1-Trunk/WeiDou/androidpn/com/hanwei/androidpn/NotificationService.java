...
public class NotificationService extends Service {
    ...
    public static final String SERVICE_NAME = "com.hanwei.androidpn.NotificationService";
	...
	public NotificationService() {
		Log.e(LOGTAG, "=======NotificationService==============");
    ...
    public void login(final String username,final String password){
        ...
        taskSubmitter.submit(new Runnable() {
            public void run() {
                NotificationService.this.getXmppManager().login(username, password);
            }
        });
    }
...
//    	}
    ...
    public class TaskTracker {
        ...
        public void clear(){
        	synchronized (notificationService.getTaskTracker()) {
				notificationService.getTaskTracker().count=0;
			}
        }
    }
