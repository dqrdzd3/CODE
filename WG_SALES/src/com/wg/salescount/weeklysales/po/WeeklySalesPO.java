package com.wg.salescount.weeklysales.po;

public class WeeklySalesPO {
	...
	public WeeklySalesPO() {
		super();
	}

	public WeeklySalesPO(String weeklySalesId, String productName, String specificationsModel, float unitPrice,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		WeeklySalesPO other = (WeeklySalesPO) obj;
		if (productName == null) {
