...
<section class="content-header">
  <h1>周销售报表</h1>
  <ol class="breadcrumb">
    <li> <a href="javascript:history.back(-1);"><i class="fa fa-send (alias)"></i>周销售报表首页</a>&nbsp;>>&nbsp;<a href="javascript:void(0);">修改记录</a></li>
  </ol>
</section>
					...
					<div class="col-sm-8">
							<div class="col-sm-6">
							  <label >产品名称：</label>
								...
								<div class="col-sm-6">
							  <input type="text" class="form-control" name="productName" value="${weeklySales.productName}">
							  </div>
					</div>
					<div class="col-sm-2">
					</div>
					...
					<div class="col-sm-8">
							<div class="col-sm-6">
							  <label>规格型号：</label>
								...
								<div class="col-sm-6">
							  <input type="text" class="form-control" name="specificationsModel" value="${weeklySales.specificationsModel}" placeholder="规格型号">
							  </div>
					</div>
					<div class="col-sm-2">
					</div>
					...
					<div class="col-sm-8">
							<div class="col-sm-6">
							  <label>单价：</label>
								...
								<div class="col-sm-6">
							  <input type="text" class="form-control" name="unitPrice" value="${weeklySales.unitPrice}" placeholder="单价">
							  </div>
					</div>
					<div class="col-sm-2">
					</div>
					...
					<div class="col-sm-8">
							<div class="col-sm-6">
							  <label>数量：</label>
								...
								<div class="col-sm-6">
							  <input type="text" class="form-control" name="quantity" value="${weeklySales.quantity}" placeholder="数量">
							  </div>
					</div>
					<div class="col-sm-2">
					</div>
					...
					<div class="col-sm-8">
							<div class="col-sm-6">
							  <label>金额：</label>
								...
								<div class="col-sm-6">
							  <input type="text" class="form-control" name="totalPrice" value="${weeklySales.totalPrice}" placeholder="金额">
							  </div>
					</div>
					<div class="col-sm-2">
					</div>
					...
					<div class="col-sm-8">
							<div class="col-sm-6">
							  <label>周数：</label>
								...
								<div class="col-sm-6">
							  <input type="text" class="form-control" name="week" value="${weeklySales.week}" placeholder="周数">
							  </div>
					</div>
					<div class="col-sm-2">
					</div>
					...
					<div class="col-sm-8">
							<div class="col-sm-6">
							  <label>年数：</label>
								...
								<div class="col-sm-6">
							  <input type="text" class="form-control" name="year" value="${weeklySales.year}" placeholder="年数">
							  </div>
					</div>
					<div class="col-sm-2">
					</div>
